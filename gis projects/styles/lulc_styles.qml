...
<qgis autoRefreshMode="Disabled" autoRefreshTime="0" hasScaleBasedVisibilityFlag="0" layerType="Raster" maxScale="0" minScale="1e+08" styleCategories="AllStyleCategories" version="4.0.2-Norrköping">
  <flags>
  ...
  <elevation band="1" enabled="0" mode="RepresentsElevationSurface" symbology="Line" zoffset="0" zscale="1">
    ...
    <profileLineSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="line">
        ...
        <layer class="SimpleLine" enabled="1" id="{099e83b7-929c-4e21-8e29-bb14d900a67a}" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{f6b50dcd-1dbe-41b2-9580-169c02229c62}" locked="0" pass="0">
          <Option type="Map">
  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" band="1" nodataColor="" opacity="1" type="paletted">
      ...
      <colorPalette>
        <paletteEntry alpha="255" color="#0055ff" label="Water" value="0"/>
        <paletteEntry alpha="255" color="#e41a1c" label="Built-up" value="1"/>
        <paletteEntry alpha="255" color="#ffff33" label="Agriculture" value="2"/>
        <paletteEntry alpha="255" color="#006837" label="Forest" value="3"/>
        <paletteEntry alpha="255" color="#aaaaaa" label="Barren" value="4"/>
      </colorPalette>
